...
variable "bastion_namespace" {
  type        = string
  description = "bastion module namespace"
}

variable "bastion_stage" {
  type        = string
  description = "bastion module stage"
}

variable "bastion_name" {
  type        = string
  description = "bastion module name"
}

variable "sg_namespace" {
  type        = string
  description = "sg module namespace"
}

variable "sg_stage" {
  type        = string
  description = "sg module stage"
}
